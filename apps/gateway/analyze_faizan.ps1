Write-Host "Analyzing C:\Users\faizan folder..." -ForegroundColor Cyan
Write-Host ""

$folders = Get-ChildItem C:\Users\faizan -Directory -Force -ErrorAction SilentlyContinue
$results = @()
...
Write-Host ""
Write-Host "=== Storage in C:\Users\faizan ===" -ForegroundColor Cyan
Write-Host ""
